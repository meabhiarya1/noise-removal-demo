...
const Progress = ({ progress }) => {
  // Ensure that uploadProgress is clamped between 0 and 100
  ...
  return (
    <div className="relative w-[60%] max-w-[500px] h-[25px] bg-gradient-to-r from-[#1b2735] to-[#090a0f] rounded-[30px] overflow-hidden shadow-[0_8px_20px_rgba(0,0,0,0.5)] border-[1px] border-[#313131]">
      <div
        className="absolute top-0 left-0 h-full bg-gradient-to-r from-[#00f260] to-[#0575e6] rounded-[30px] animate-grow shadow-[0_0_15px_#00f260,0_0_30px_#0575e6]"
